...
export class migrations1673592115925 implements MigrationInterface {
  name = 'migrations1673592115925';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "department" ("isDeleted" boolean NOT NULL DEFAULT false, "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdatedOn" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "department_name" character varying NOT NULL, "hod" integer NOT NULL, "userId" integer, CONSTRAINT "PK_9a2213262c1593bffb581e382f5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
